...
class AdminControllerTest extends AdminBundleWebTestCase
{
    private $searchTerms = array(
                Constants::SEARCH_CATEGORY_INSTITUTION => 'Institution', 
    			Constants::SEARCH_CATEGORY_CENTER => 'Medical Center',
    			Constants::SEARCH_CATEGORY_SPECIALIZATION => 'Procedure Type',
    			Constants::SEARCH_CATEGORY_SUB_SPECIALIZATION => 'Sub Specialization',
    			Constants::SEARCH_CATEGORY_PROCEDURE_TYPE => 'Specialization',
    			Constants::SEARCH_CATEGORY_DOCTOR => 'Doctor',
    );
