...
class MedicalCenterStatusToBooleanTransformer implements DataTransformerInterface
{
    /**
     * Transforms the MedicalCenter status property (int) to a boolean field type.
     *
     * @param  int $status
     * @return boolean|null
     */
