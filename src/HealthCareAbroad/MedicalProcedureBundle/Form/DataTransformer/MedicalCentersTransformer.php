...
class MedicalCentersTransformer implements DataTransformerInterface
{
    /**
     * @var EntityManager
     */
    ...
    public function reverseTransform($stringCenters)
    {
    	...
    	foreach($centers as $centerName) {
    		$center = $this->em->getRepository('MedicalProcedureBundle:MedicalCenter')->findOneBy(array('name'=>trim($centerName)));
