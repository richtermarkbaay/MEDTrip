 ...
 *
 */
namespace HealthCareAbroad\PagerBundle\Test;
...
class PagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->adapter = $this->getMock('HealthCareAbroad\PagerBundle\Adapter\PagerAdapterInterface');
    ...
    {
        $adapter = $this->getMock('HealthCareAbroad\PagerBundle\Adapter\PagerAdapterInterface');
