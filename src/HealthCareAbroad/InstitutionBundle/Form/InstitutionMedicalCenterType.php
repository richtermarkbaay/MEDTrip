...
class InstitutionMedicalCenterType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if (!$institutionMedicalCenter->getId()) {
            ...
            $builder->add('medicalCenter', 'medicalCenter_list', array('label' => 'Specialization','query_builder' => function (EntityRepository $er) use ($institution) {
            ...
            $builder->add('medicalCenter', 'medicalCenter_list', array('label' => 'Specialization', 'query_builder' => function(EntityRepository $er) use($medicalCenterId){
