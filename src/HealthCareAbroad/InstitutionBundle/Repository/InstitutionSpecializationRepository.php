...
class InstitutionSpecializationRepository extends EntityRepository
{
    ...
    /** TODO - Never been used, this might be already DEPRECATED!
...
//         $qry = "SELECT b.* FROM institution_sub_specializations AS a " .
//                "JOIN treatments AS b ON a.treatment_id = b.id " .
