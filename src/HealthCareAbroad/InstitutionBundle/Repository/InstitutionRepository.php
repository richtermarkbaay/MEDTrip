...
class InstitutionRepository extends EntityRepository
{
    ...
    {
        $dql = "SELECT a FROM InstitutionBundle:Institution a INNER JOIN a.institutionMedicalCenters b WHERE a.country = :country AND a.status <> :status AND b.status = :imcStatus ";
    ...
    {
        $dql = "SELECT a FROM InstitutionBundle:Institution a INNER JOIN a.institutionMedicalCenters b WHERE a.city = :city AND a.city IS NOT NULL AND a.status <> :status AND b.status = :imcStatus";
