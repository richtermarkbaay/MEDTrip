var GlobalAwardTranslationModalFormView = Bootstrap3ModalForm.extend({
    
    el: $('#modal_translation_form'),
    
    fieldMapping: {
        'name': 'globalAwardTranslation[name]',
        'details': 'globalAwardTranslation[details]',
        'languageIso': 'globalAwardTranslation[languageIso]'
    },
