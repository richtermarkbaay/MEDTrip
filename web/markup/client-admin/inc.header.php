...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container">
		<a href="index.php" class="brand"><img src="images/HCA-logo-small.png" alt="Health Care Abroad Logo" longdesc="#"> HEALTHCARE ABROAD</a>
			<div class="btn-group pull-right">
       		     
       		     <span class="userbox">you are logged in as<i class="icon-user"><a href="#"></i>marcjacob@gmail</a></span>
       		     <a href="accountsettings.html"><img src="images/Setting-icon.png"></a>
       		     <a href="logout.html"><img src="images/logout-icon.png"></a>
       		 </div>
...
<div class="institutionbox">
	<div class="container">
		<div class="institutionbox-inner"> 
			<div class="navbar-inner">
	   	 		<div class="span6">
	        		<div class="span2"><a href="#"><img class="member-box-avatar" src="http://images.goabroad.net/images/default_images/profile_photo.gif"></a></div>
			        <div class="span7"><h3>Institution Name Here</h3></div>
			    </div>
		    	<div class="span5">
	    			<a href="#"><h2>Manage Your Institution Profile</h2></a>
...
<div class="container">
	...
	<div id="box-1">
	  <span class="span1"><a href="javascript:toggleDiv('myContent');"><img src="images/arrow.png"></a> </span>    
