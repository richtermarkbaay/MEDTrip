			...
			<body>Top navigation bar
				<div class="navbar navbar-fixed-top">
					...
					<div class="navbar-inner">
					                <div class="container">
					                  <a href="index.php" class="brand"><img src="images/institution/HCA-logo-small.png" alt="Health Care Abroad Logo" longdesc="#" title=""> HEALTHCARE ABROAD</a>
					           ...
					           <nav>
					           	<ul class="menu pull-right">
					           		...
					           		<li><a href="#">MENU</a>
					           			<ul>
					           				<li><a href="#"><i class="icon-home"></i>Main Dashboard</a></li>
					     					<li>
					           				...
					           				<li>
					           					<a href="staff.html"><i class="icon-user"></i>Staff Listing</a>
					           				</li>
					           				<li>
					           					<a href="affiliations.php"><i class="icon-certificate"></i>Affiliations / Certifications</a>
					           				</li>
					           				<li>
