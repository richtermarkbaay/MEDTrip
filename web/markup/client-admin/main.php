		...
		<div class="maincontent">
			...
			<?php include( "inc.sidebar.php"); ?>
				...
				<div class="span9 title">
							...
							<div id="Comments" class="accordion-body collapse in">
								<div class="accordion-inner">
									<div class="commentsbox">
										<div id="comment1">
											<div class="span12">
												<a href="#"><b>Dave Sparks</b> - Phoenix, Arizona</a>
												</span>
												<small>&nbsp;&nbsp;&nbsp;
													<a href="#">12 Oct 09 at 7:09 am</a>
												</small>
												<p style="padding: 0; margin: 0;">Type of Treatment:&nbsp;&nbsp;&nbsp;
													<a href="#">Treatment 1</a>
													<!--&nbsp;&nbsp;&nbsp;Performed by&nbsp;&nbsp;&nbsp;<a href="#">Dr. First Lastname</a>Type of Treatment:&nbsp;&nbsp;&nbsp;<a href="#">Treatment 1</a>&nbsp;&nbsp;&nbsp;Performed by&nbsp;&nbsp;&nbsp;<a href="#">Dr. First Lastname</a>-->
												</p>
												<p style="padding: 0; margin: 0;">Date of Procedure:&nbsp;&nbsp;&nbsp;
													<a href="#">12 Oct 09 at 7:09 am</a>
												</p>
												<p style="padding: 0; margin: 0;">Medical Specialist Assigned:&nbsp;&nbsp;&nbsp;
													<a href="#">Dr. First Lastname</a>
												</p>
												<span class="span1 pull-left">Ratings:</span>
												<ul class="span2 rating onestar" style="margin-top:-18px ; margin-left: 50px;">
													<li class="one">
											...
											<div class="pull-right">
												<a data-toggle="modal" class="btn btn-danger" role="button" href="#Edit">Report as Spam</a>
									...
									<div class="treatmentbox">
										<div class="boxcontent">
											<span class="pull-left">
												<a href="#"><img alt="..." src="images/institution/institution-logo.gif"/></a>
											</span>
					...
					<div class="accordion" id="accordion2">
						<div class="accordion-group">
							<h4>Recently Added Medical Specialist
								<span class="pull-right">
									<button class="btn btn-mini">
										<i class="icon-edit"></i>Add Medical Specialist</button>
								</span>
							</h4>
							<div id="MedicalListing" class="accordion-body collapse in">
								<div class="accordion-inner">
									<div class="treatmentbox">
										<div class="boxcontent">
											<div class="specialist">
												<div class="span4">
													<div class="span1">
														<a href="#"><img class="member-box-avatar" src="images/institution/institution-logo.gif"></a>
													</div>
													<div class="span3">
														<h5>Dr. First Name Last Name</h5>
														<p>Specialization</p>
														<button class="btn btn-small btn-mini">View Specialist's Profile</button>
													</div>
												</div>
												<div class="span4">
													<div class="span1">
