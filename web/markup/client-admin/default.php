			...
			<div class="span12" style="margin-left: 0;">
					...
					<div class="tabbable">
											...
											<ul class="nav nav-tabs"> 
												...
												<li><a data-toggle="tab" href="#tabs1-pane1"> <i class="icon-home"></i> Dashboard</a></li>
												<li><a data-toggle="tab" href="#tabs1-pane2"> <i class="icon-star"></i> Institution Profile</a></li>
												<li><a data-toggle="tab" href="#tabs1-pane3"> <i class="icon-star"></i> Medical Center</a></li>
												<li><a data-toggle="tab" href="#tabs1-pane4"> <i class="icon-user"></i>Doctors Listing</a></li>
												<li><a data-toggle="tab" href="#tabs1-pane5"> <i class="icon-certificate"></i>Affiliations / Certifications</a></li>
												<li><a data-toggle="tab" href="#tabs1-pane6"> <i class="icon-picture"></i>Media Gallery</a></li>
												<li><a data-toggle="tab" href="#tabs1-pane7"> <i class="icon-thumbs-up"></i> Buy Ads</a></li>
												<li><a data-toggle="tab" href="#tabs1-pane8"> <i class="icon-info-sign"></i>Help</a></li>
											...
											<div class="tab-content">
												...
												<div id="tabs1-pane6" class="tab-pane active">
																			
																				1
																			</div>
												<div id="tabs1-pane7" class="tab-pane">
																
																		2
															</div>
												<div id="tabs1-pane8" class="tab-pane">
																
																3
																
															</div>
												<div id="tabs1-pane9" class="tab-pane">
												
													
																		3																
																	</div>
												<div id="tabs1-pane10" class="tab-pane">
				...
				<div class="sidebar-nav">
					...
					<ul class="nav nav-tabs nav-stacked">
			            <li class="nav-header">Latest System Messages</li>        
			            <li><a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean bibendum, est at congue gravida...</a></li>
			            <li><a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean bibendum, est at congue gravida...</a></li>
			            <li><a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean bibendum, est at congue gravida...</a></li>
			      	</ul> 
			      	</div>
									...
									<div>
										...
										<div class="box" id="box-1">
										  	<h4>Specialization 1
										  		...
										  		<span><img src="images/institution/plus.png"></span>
										  		</a>
										  	</h4>         
										</div>
									...
									<div>
										...
										<div class="box" id="box-1">
											...
											<div id="menu2">
										    	...
										    	<label><input type="checkbox" />Treatment</label>
										    	<label><input type="checkbox" />Treatment</label>
										    	<label><input type="checkbox" />Treatment</label>   
