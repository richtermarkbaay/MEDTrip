...
;(function($) {
	...
	var methods = {
		init: function(options) {
        	...
        	$('<a/>', { id: id + '-back-' + index, href: 'javascript:void(0);', 'class': 'button-back btn btn-medium btn-info', html: opt.backLabel }).click(function() {
        	...
        	$('<a/>', { id: id + '-next-' + index, href: 'javascript:void(0);', 'class': 'button-next btn-medium  btn btn-info', html: opt.nextLabel }).click(function() {
